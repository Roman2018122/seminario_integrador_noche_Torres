...
function crearEstadoVehiculo(estado, mayusculas) {
...
console.log(registrarMensaje("Vehículo recibido"));
// ℹ️ INFO: Vehículo recibido
console.log(registrarMensaje("Cambio de aceite próximo", "advertencia"));
// ⚠️ ADVERTENCIA: Cambio de aceite próximo
console.log(registrarMensaje("Error al registrar la orden", "error", true));
// ❌ ERROR [2026-...]: Error al registrar la orden
/* Mini-ejercicio — formatear costo */
function formatearCosto(costo, moneda = "USD", decimales = 2) {
