...
const mantenimiento2 = kilometraje >= 50000
...
const costoServicio = 45.50;
const tipoServicio = costoServicio >= 40 ? "Servicio mayor" : "Servicio básico";
console.log(`Costo: $${costoServicio} — ${tipoServicio}`);
// No anidar ternarios — difícil de leer
// ✅ Mejor usar if/else para tres o más casos
const prioridad = costoServicio >= 100 ? "Alta" :
